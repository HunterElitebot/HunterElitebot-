...
VERSION = "V11.60 TOP1/LP/AGE GATE FIX"
...
Yeni giris icin uygun degil."""
            ...
            if now_diag - last_diag_send >= 300 and stats.get("watch", 0) == 0 and stats.get("signal", 0) == 0:
                diag = (
                    ...
                    f"> GATE_OK={stats.get('gate_ok',0)} (top1_fail={stats.get('top1_fail',0)} lp_fail={stats.get('lp_lock_fail',0)} age_fail={stats.get('min_age_fail',0)}) "
