...
VERSION = "V11.39 FAIL-CLOSED + SIGNAL TRACKING"
...
TREND_MIN_CONFIRMATIONS = int(os.getenv("TREND_MIN_CONFIRMATIONS", "2"))
...
SIGNAL_LOG_FILE = "/tmp/hunterelite_signal_performance.json"
...
def record_signal_entry(ca, name, symbol, pair):
    ...
    with signal_perf_lock:
        signal_perf[ca] = {
            ...
            "entry_price": entry_price, "entry_mc": entry_mc,
...
def auto_scanner():
    ...
    "momentum_pass": 0, "liq_confirmed": 0, "liq_wait": 0, "liq_drop_block": 0, "clone_block": 0, "signal_gate_pass": 0,
        ...
        or (top10 is not None and top10 < HOLDER_TOP10_MAX)
                    ...
                    rug_ok = holder_ok and not sig.get("rug") and not sig.get("honeypot") and not sig.get("unknown")
...
Early Entry: MC $500+, Liquidity {money(MIN_LIQUIDITY)}+, Top10 <{HOLDER_TOP10_MAX:.0f}%\nHard rug/honeypot and authority checks remain active.\n\nSTATE DECISION LOCK + CENTRAL OUTPUT + LIQ FALLBACK: ACTIVE.\nAutomatic signal engine is running.""")
